...
class FunctionTool:
    ...
    # async def _on_invoke_tool_wrapper(self, ctx: RunContextWrapper[Any], input_json: str) -> Any:
    #     logger.info(f"FunctionTool received: ctx={ctx}, input_json={input_json!r}")
    #     return await self.on_invoke_tool(ctx, input_json)
