# Carrier Framework Project
## Based on OpenAI Agents SDK

### Testing
View Agent convesation logs [**here**](https://platform.openai.com/logs)
...
I'd like to acknowledge the excellent work of the open-source community, especially:
