...
from src.carrier.tools import GET_WEATHER, generate_image
    ...
    for tool_name in tool_config:
        if tool_name in tool_mapping:
            ...
            if tool_name == "GET_WEATHER":
                ...
                usage = "\nExample usage: generate_image('A beautiful sunset over mountains') would generate and return an image of a sunset over mountains."
                description += usage
